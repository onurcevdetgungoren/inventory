class PaletSatis {
  ...
  PaletSatis(this._kalite, this._cins, this._en, this._metraj, this._id,
      this._boy, this._isim, this._qrurl, this._musteriad);

  PaletSatis.fromMap(Map<String, dynamic> gelenMap) {
  ...
  String toString() {
    ...
    return 'PaletSatis{_kalite: $_kalite, _cins: $_cins, _en: $_en, _metraj: $_metraj, _id: $_id, _boy: $_boy, _isim: $_isim, _qrurl: $_qrurl, _musteriad: $_musteriad}';
  }
}
